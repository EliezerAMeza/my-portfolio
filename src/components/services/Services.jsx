    ...
    <section className="services section" id="services">
      ...
      <div className="services__container container grid">
        <div className="services__content">
          <div>
            <div className="uil uil-web-grid services__icon"></div>
        ...
        <div className="services__content">
          <div>
            <div className="uil uil-arrow services__icon"></div>
            <h3 className="services__title">
              Ui/Ux <br /> Designer
            </h3>
          </div>
        ...
        <div className="services__content">
          <div>
            <div className="uil uil-edit services__icon"></div>
            <h3 className="services__title">
              Visual <br /> Designer
            </h3>
          </div>
